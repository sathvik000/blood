...
<body>
  ...
  <div class="card">
    <img src="images\Noor.jpeg" class="card-img-top team-img" alt="sujal" style="height:50%">
    <div class="card-body">
      <h4 class="card-title">Sujal payal</h4>
      <p class="card-text">Sujal payal is a valuable team member with expertise in frontend, ReactJS, and WordPress. His dedication to growth and continuous learning makes him a valuable asset to any software development project. With a strong foundation in these areas, Noor Ahmed is well-equipped to make valuable contributions to the team..</p>      
	  <div class="row p-2">
	  <!-- <ul class="top-right-info">                            
                                <li class="mx-3">
  ...
  <div class="card">
    <img src="images\ritik.jpeg" class="card-img-top team-img" alt="sathvik" style="height:50%">
    <div class="card-body">
      <h4 class="card-title">Sathvik </h4>
      <p class="card-text">Sathvik valuable team member with expertise in Python and frontend technology. His dedication to growth and continuous learning makes him a valuable asset to any software development project. With a strong foundation in these areas and a passion for staying current, Ritik is well-equipped to make valuable contributions to the team.</p>      
	  <div class="row p-2">
	  <!-- <ul class="top-right-info">                            
                                <li class="mx-3">
